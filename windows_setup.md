...
4. [Navigating the CHERIoT Ecosystem](https://cheriot.org/rtos/sonata/git/2024/11/08/navigating-the-ecosystem.html) This is a useful document that discusses the different repositories available and teh pros and cons of each. It *should* (like this document) become largely obolete with the release of CHERIO-RTOS V1.0.
